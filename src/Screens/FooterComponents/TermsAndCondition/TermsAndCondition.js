...
<li>
  {t("General Provisions")}
    ...
    >
      ...
      >
        {t("1.2 If you wish to contact Mekatourizm, please visit our Mekatourizm Customer Care page giving information about ways to contact us. You can also write to us at the following address: Mekatourizm, Inc., 400 1st Avenue, Needham, MA 02494, USA")}.</Typography>
    <Typography
    sx={{
      fontSize:{xs:"16px",md:"18px"}
    }}
    ...
    >
      ...
      >
        {t("2.2 Your use of the Services is permitted by Mekatourizm only for personal, non-commercial use and/or to make legitimate requests to make a Booking of the Products offered. You agree not to use this Services to make any speculative, false or fraudulent requests or Bookings.")}
      </Typography>
      ...
      >
        {t("2.3 You further represent and warrant that you (a) are not currently suspended and have not previously been banned by Mekatourizm from using the Services; (b) are not acting on behalf of a competitor of Mekatourizm; (c) will not create more than one Mekatourizm Account; and (d) have full power and authority to enter into this legally binding agreement and in doing so will not violate any other agreement to which you are a party.")}
      </Typography>
      ...
      >
        {t("2.5 In accessing or using the Website, you may be exposed to content that is offensive, indecent, inaccurate, objectionable, or otherwise inappropriate. Mekatourizm does not endorse such content, and cannot vouch for its accuracy. You therefore access and use the Website at your own risk.")}
    ...
    >
        ...
        >
          {t("3.1 You may need to create a Mekatourizm Account and provide information about yourself in order to use some of the features on the Website and other Services, including when you make a Booking. You are responsible for maintaining the confidentiality of your Mekatourizm Account password and log-in credentials (Mekatourizm Account Credentials). You are also solely responsible for all activities (including Bookings) that occur in connection with your Mekatourizm Account. You agree to notify us immediately of any unauthorized use of your Mekatourizm Account.")}
        </Typography>
        ...
        >
          {t("3.2 Your Mekatourizm Account is for your personal use only. You may not impersonate someone else (e.g., adopt the identity of a celebrity), create a Mekatourizm Account for any person other than yourself, provide an e-mail address or other personal details other than your own, or create multiple Mekatourizm Accounts.")}
        </Typography>
        ...
        >
          {t("3.3 We may terminate or suspend access to your Mekatourizm Account or your ability to use the Services, in whole or in part, at our sole discretion, for any or no reason, and without notice or liability of any kind. For example, we may terminate or suspend your Mekatourizm Account or ability to use the Services if you misuse the Website. Any such termination or suspension could prevent you from accessing your Mekatourizm Account, the Website, User Content (as defined in Section 6.1), Website Content (as defined in Section 4.1), and/or any other related information.")}
        </Typography>
        ...
        >
          {t("3.4 You may terminate your Mekatourizm Account at any time by contacting us to request that we close your Mekatourizm Account, and by discontinuing your use of any and all parts of the Services. If you close your Mekatourizm Account, we may continue to display your previously published User Content and are under no obligation to remove any of your User Content.")}
        </Typography>
        ...
        >
          {t("3.5 AS A USER OF THE SERVICES, YOU UNDERSTAND AND AGREE THAT:")} {t("(1) NEITHER Mekatourizm NOR ITS AFFILIATES WILL HAVE ANY LIABILITY TO YOU OR OTHERS FOR ANY UNAUTHORIZED BOOKINGS MADE USING YOUR Mekatourizm ACCOUNT AND/OR Mekatourizm ACCOUNT CREDENTIALS; AND (2) THE UNAUTHORIZED USE OF YOUR Mekatourizm ACCOUNT AND/OR Mekatourizm ACCOUNT CREDENTIALS COULD CAUSE YOU TO INCUR LIABILITY TO BOTH Mekatourizm AND OTHER USERS")}
          .</Typography>
    ...
    >
        ...
        >
          {t("5.1. When you use the Mekatourizm Website, or send e-mails, text messages, and other communications from your desktop or mobile device to us, you are communicating with us electronically and agree that we may communicate with you in a variety of ways, such as by e-mail, in-app push notices, or by posting notices and messages on the Website. You may unsubscribe from marketing-related e-mails by emailing unsubscribe@Mekatourizm.com, however we may continue to send you non-marketing messages, such as messages related to any upcoming Bookings.")}
        </Typography>
    </Box>
    ...
    >
      ...
      >
        {t("d. content that impersonates any person or entity or otherwise misrepresents your affiliation with a person or entity, including Mekatourizm;")}
      </Typography>
    ...
    >
        ...
        >
          {t("7.4 In some cases you may be asked on a Third Party Site if you wish to link your profile on Mekatourizm to a profile on such Third Party Site. Choosing to do so is optional. If you decide to link your profiles and you later wish to disable such link, you should contact the Third Party Site.")}
        </Typography>
    ...
    >
        ...
        >
          {t("10.3 Mekatourizm is not a travel agency and does not provide or own any Experiences. Although Mekatourizm provides the Website with information about Products and facilitates Bookings, such actions do not in any way constitute Mekatourizm's sponsorship or approval of such Suppliers, or any affiliation between Mekatourizm and any Supplier. Although Mekatourizm Members may rate and review particular Products based on their own experiences, Mekatourizm does not endorse or recommend any Products. You agree that Mekatourizm is not responsible for the accuracy or completeness of information it obtains from Suppliers and/or that is displayed on the Website.")}
        </Typography>
    ...
    >
      ...
      >
        {t("11.2 Prices are based on the local tariff at the time of quoting, converted at the prevailing foreign-exchange rate as determined by Mekatourizm. See Section 12 for more information about currency conversions.")}
      </Typography>
    ...
    >
      ...
      >
        {t("14.1 Under these Terms of Use, the payment processing services for the Services provided are provided by Mekatourizm Limited (on behalf of Mekatourizm Inc.), or by Mekatourizm Inc., or by Mekatourizm Systems Pty Limited, depending on the payment method used for your Booking. Mekatourizm Limited's registered office address is 7 Soho Square, London W1D 3QB, UK. Mekatourizm Systems Pty Limited's registered office address is Level 5, 219 Cleveland St, Redfern, NSW 2016, Australia.")}
      </Typography>
      ...
      >
        {t("14.2 In the event you make a Booking using a credit or debit card and your payment is processed via a European acquirer, the payment processing services will be provided by Mekatourizm Limited on behalf of Mekatourizm Inc. (generally indicated by Mekatourizm Limited being referenced on your card statement). For a Booking made using any other payment method, the payment processing services will be provided by either Mekatourizm Inc. or Mekatourizm Systems Pty Limited (as stated on the applicable payment statement). If your payment was processed by Mekatourizm Limited or Mekatourizm Inc., the Terms of Use constitute an agreement between you and Mekatourizm Inc. If your payment was processed by Mekatourizm Systems Pty Limited, the Terms of Use are an agreement between you and Mekatourizm Systems Pty Limited, and the Services are provided to you by Mekatourizm Systems Pty Limited. For the avoidance of doubt, these Terms of Use never constitute an agreement between you and Mekatourizm Limited.")}
      </Typography>
    </Box>
    ...
    >
      {t("16.1 Occasionally a Supplier may make a change to a Product after your purchase, including but not limited to the date, price, inclusions, coverage, age requirements, and/or any other Product features and/or requirements. As a result, Mekatourizm (acting on the Supplier’s behalf), reserves the right to cancel, change or substitute any Product that you have purchased, at any time, for any reason. If the change proposed by the Supplier is material (for example, a change in dates and/or a significant change to the itinerary), and you are dissatisfied with the alternative that is offered, you will be entitled to a full refund of the original purchase price.")}
    </Typography>
    ...
    >
      ...
      >
        {t("17.4 Mekatourizm strongly recommends that you purchase a comprehensive travel insurance policy prior to departure to protect your Product purchase. If you cancel your trip or significantly alter travel dates, your travel insurance policy may reimburse the cost of cancellation fees and related expenses. Please review your travel insurance policy carefully for related terms and conditions.")}
      </Typography>
      ...
      >
        {t("17.6 Mekatourizm DOES NOT REPRESENT OR WARRANT THAT TRAVEL TO ANY DESTINATION IS ADVISABLE OR WITHOUT RISK, AND Mekatourizm IS NOT LIABLE FOR DAMAGES OR LOSSES THAT MAY RESULT FROM TRAVEL TO SUCH DESTINATIONS.")}
      </Typography>
    </Box>
    ...
    >
      ...
      >
        {t("18.1 PLEASE READ THIS SECTION CAREFULLY. THIS SECTION LIMITS Mekatourizm'S LIABILITY TO YOU FOR ISSUES THAT MAY ARISE IN CONNECTION WITH YOUR USE OF THE SERVICES. IF YOU DO NOT UNDERSTAND THE TERMS IN THIS SECTION OR ELSEWHERE IN THESE TERMS OF USE, PLEASE CONSULT A LAWYER FOR CLARIFICATION BEFORE ACCESSING OR USING THE SERVICES.")}
      </Typography>
    ...
    >
      ...
      >
        ...
        >
          {t("20.3 In order to benefit from this policy, you must supply Mekatourizm with correct arrival and departure ship information and ensure there is enough time (minimum 2 hours) between the Experience end time and the ship departure time. You must contact Mekatourizm directly and as soon as possible to request next port-of-call transportation arrangements as you cannot book your own travel without voiding this policy.")}
        </Typography>
        ...
        >
          {t("20.4 Subject to your eligibility, Mekatourizm will facilitate the booking of travel for you to the next port of call (not to exceed US$1,000 per person).")}
        </Typography>
    ...
    >
      ...
      >
        {t("21.4 In some cases, a Supplier may also require that you present the payment card used to purchase your Product at the time of redemption. This typically applies to attraction and show tickets. You should be advised at check-out whether or not this will be required. If you have questions about such a requirement, contact Mekatourizm's Customer Care team.")}
      </Typography>
    </Box>
    ...
    >
      {t("22.1 You agree that no joint venture, agency, partnership, or employment relationship exists between you and any of the Mekatourizm Group Companies as a result of these Terms of Use or use of the Services.")}
    </Typography>
    ...
    >
      {t("22.2 Mekatourizm's performance of these Terms of Use is subject to existing laws and legal process, and nothing contained in these Terms of Use limits Mekatourizm's right to comply with law enforcement or other governmental or legal requests or requirements relating to your use of the Services or information provided to or gathered by Mekatourizm with respect to such use. To the extent allowed by applicable law, you agree that you will bring any claim or cause of action arising from or relating to your access or use of the Services within two (2) years from the date on which such claim or action arose or accrued or such claim or cause of action will be irrevocably waived.")}
    </Typography>
