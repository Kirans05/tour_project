        ...
        <Box className="Effective: 25 March 2021">
          ...
          <Box>
            <ol>
              ...
              <li>Information Choices</li>
              <li>Information Transfers</li>
              <li>Information Security</li>
              <li>Information Retention</li>
              <li>Do Not Track Signals</li>
              <li>Cookies</li>
              <li>Cookie Consent Tool</li>
              <li>Statement Changes and Notification</li>
              <li>Contact</li>
              <li>Europe</li>
              <li>California</li>
            </ol>
      ...
      <Box className="details">
        <Box className="Information Collected">
          ...
          <Typography>
            ...
            you use our Services by “clicking-through” from a third-party site
            or when you visit third-party sites via our Services, those
            third-party sites may share information with us about your use of
          ...
          <Box className="ul">
            <ul>
              ...
              <li>
                ...
                cardholder name, expiration date, authentication code and
                billing address)
              </li>
              <li>User name and password</li>
              <li>
                Photos, reviews and social posts and videos you may have
                provided to us
              </li>
          ...
          <Typography>
            ...
            may use your location to show you reviews of hotels, restaurants or
          ...
          <Typography>
            ...
            affect certain features that we offer. If you have any questions
            about the privacy settings of your Device, we suggest you contact
            the manufacturer of your Device or your mobile service provider for
            help.
          </Typography>
        ...
        <Box className="Information Uses">
          ...
          <Box className="ul">
            <ul>
              ...
              <li>
                Customize your experience, including customizing the ads shown
                to you on our Services and across the internet
              </li>
              <li>Make inferences about your interests or preferences</li>
              <li>
                Provide you with an optimized experience and to group users of
                our Services based on, for example, usage and demographics
              </li>
...
<li>Business Partners. We may share information about you, your Devices and your use of our Services with our trusted business partners. For example, we may share information so that we can provide you with relevant content or in order to facilitate payment for a booking. This sharing is generally pursuant to written agreements which include confidentiality, privacy and security obligations; however, note that we do not control the privacy practices of these third-party business partners.</li>
<li>Social Media Sites. When you use our Services and elect to share information with third-party social media sites, the information you share will be governed by the privacy policies of those social media sites and the privacy settings you have set with those social media websites.</li>
<li>Advertising Networks. We sometimes collect and share information about your interests with advertising networks. Some of these companies are members of the Network Advertising Initiative or the Digital Advertising Alliance, which offer a single location to opt-out of ad targeting from member companies. To learn more, please click here.</li>
...
<li>You will be given the opportunity to unsubscribe from promotional messages, including emails with travel-related opportunities, in any such promotional message we send.</li>
                    </ul>
                  </Box>
        </Box>
